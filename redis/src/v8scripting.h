...
struct redisDb {
    dict *dictPtr;                 /* The keyspace for this DB */
...
struct clusterNode {
    ...
    clusterNode *slaveof; /* pointer to the master node */
...
struct redisServer {
    ...
    redisCommand *delCommand, *multiCommand, *lpushCommand, *lpopCommand,
                        *rpopCommand;
    ...
    saveparam *saveparams;   /* Save points array for RDB */
